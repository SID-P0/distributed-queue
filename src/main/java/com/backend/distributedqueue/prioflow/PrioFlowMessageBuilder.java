...
public class PrioFlowMessageBuilder {
     ...
     * @param prioFlowName The name of the priority flow.
     * @return A fully constructed Job message ready to be sent.
     */
    public static Job buildNewPriorityFlowJob(String jobId, String createdBy, String prioFlowName) {
        ...
        Job job = Job.newBuilder()
                ...
                .setJobDescription("Job for processing priority flow: " + prioFlowName)
